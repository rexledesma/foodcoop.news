...
export function AppleWalletCard({
  ...
  return (
    <div className="w-full max-w-sm" style={{ perspective: '1000px' }}>
      ...
      <div
        className="relative aspect-[1.586/1] w-full overflow-hidden rounded-2xl shadow-xl transition-transform duration-300 ease-out hover:shadow-2xl"
        style={{
      ...
      >
        ...
        <div className="absolute top-4 right-4 left-4 flex items-start justify-between">
          <div className="flex items-center gap-2">
            ...
            <img src="/assets/coop-padded.png" alt="Park Slope Food Coop" className="h-7 w-auto" />
          </div>
        </div>

        {/* Primary field - Member name (editable) */}
        <div className="absolute top-1/3 right-4 left-4">
          <label
          ...
          <div className="group relative">
            <input
              ...
              className="w-full rounded-t border-b border-dashed bg-transparent px-1 py-0.5 text-xl font-semibold transition-colors placeholder:text-zinc-400 focus:outline-none"
              style={{
            ...
            />
            <PencilIcon
              className="pointer-events-none absolute top-1/2 right-1 h-4 w-4 -translate-y-1/2 transition-colors"
        ...
        <div className="absolute right-4 bottom-[18%] left-4">
          <label
          ...
          <div className="group relative w-fit">
            <input
              ...
              placeholder="000000"
              className="w-32 rounded-t border-b border-dashed bg-transparent px-1 py-0.5 text-xl font-semibold transition-colors placeholder:text-zinc-400 focus:outline-none"
              style={{
                color: passForeground,
                borderColor: passForegroundSoft,
              }}
...
function PencilIcon({ className, style }: { className?: string; style?: CSSProperties }) {
  return (
    <svg
      className={className}
      style={style}
