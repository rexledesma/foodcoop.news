...
export function Navigation() {
  ...
  return (
    <nav className="fixed bottom-0 md:bottom-auto md:top-0 left-0 right-0 bg-white dark:bg-zinc-900 border-t md:border-t-0 md:border-b border-zinc-200 dark:border-zinc-800 safe-area-pb md:safe-area-pb-0 md:safe-area-pt z-50">
